...
const PagesCard :React.FC<CardProps> = ({label,title, link, description}) :ReactNode=> {
  return (
    <div className={`${label} lg:w-120 lg:h-120 w-100 h-100 rounded-xl border border-black/20 bg-gradient-to-b from-white/25 via-white/10 to-transparent  flex items-center justify-center shadow-md transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl `}>
